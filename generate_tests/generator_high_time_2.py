...
configs = {'lim_1': '--limited-search-depth=1', 'lim_2': '--limited-search-depth=2',  'without_source': '--disable-aggr-on-source', 'without_resp': '--disable-aggr-on-resp-time', 'without_lim': '--disable-limited-search', 'without_redesign': '--disable-redesign'}
